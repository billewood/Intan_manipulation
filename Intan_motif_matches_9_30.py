...
# first i need stimuli in a format i can use:
# stim_name : ids
# stim_times: times of stimuli, in s(?)
# stim_duration: duration of stimuli, in s(?)
# I stuck this all in 'playbacks' so I could sort it by time
...
for i in range(len(good_matches)):
    ...
    sound = sound[fs_mic * zoomed[i][0]:sound[fs_mic * zoomed[i][1]]]    
    t, freq, timefreq, rms = spectrogram(sound, sample_rate, 1000, 50)
    figure()
    plot_spectrogram(t, freq, timefreq, dBNoise=80, colorbar = False)
